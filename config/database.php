...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // SQL Express connection for Punch Logs
        'sqlexpress' => [
            'driver' => 'sqlsrv',
            'host' => env('SQLEXPRESS_HOST', 'localhost'),
            'port' => env('SQLEXPRESS_PORT', '1433'),
            'database' => env('SQLEXPRESS_DATABASE', 'PunchDB'),
            'username' => env('SQLEXPRESS_USERNAME', ''),
            'password' => env('SQLEXPRESS_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'encrypt' => 'no',
