...
# Downgrade OpenSSL security level to allow legacy SQL Server connections
# This is required for connecting to older SQL Servers that use legacy TLS/Cipher suites
